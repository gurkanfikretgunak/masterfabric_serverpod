...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1369: (x0,x1) => x0.querySelector(x1),
      _1370: (x0,x1) => x0.getAttribute(x1),
      _1371: (x0,x1) => x0.createElement(x1),
      _1372: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1380: (x0,x1) => x0.removeItem(x1),
      _1382: (x0,x1) => x0.getItem(x1),
      _1383: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1384: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1385: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1386: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1387: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1388: (x0,x1,x2) => x0.setItem(x1,x2),
      _1389: (x0,x1) => x0.getRandomValues(x1),
      _1390: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1391: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1398: Date.now,
      ...
      _1411: x0 => new WeakRef(x0),
      _1412: x0 => x0.deref(),
      _1419: () => globalThis.WeakRef,
      _1423: s => JSON.stringify(s),
      _1424: s => printToConsole(s),
      _1425: (o, p, r) => o.replaceAll(p, () => r),
      _1427: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1428: s => s.toUpperCase(),
      _1429: s => s.trim(),
      _1430: s => s.trimLeft(),
      _1431: s => s.trimRight(),
      _1432: (string, times) => string.repeat(times),
      _1433: Function.prototype.call.bind(String.prototype.indexOf),
      _1434: (s, p, i) => s.lastIndexOf(p, i),
      _1435: (string, token) => string.split(token),
      _1436: Object.is,
      _1437: o => o instanceof Array,
      _1442: a => a.pop(),
      _1443: (a, i) => a.splice(i, 1),
      _1444: (a, s) => a.join(s),
      _1445: (a, s, e) => a.slice(s, e),
      _1447: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1448: a => a.length,
      _1450: (a, i) => a[i],
      _1451: (a, i, v) => a[i] = v,
      _1453: o => {
      ...
      _1454: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1456: o => o instanceof Uint8Array,
      _1457: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1458: o => o instanceof Int8Array,
      _1459: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1460: o => o instanceof Uint8ClampedArray,
      _1461: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1462: o => o instanceof Uint16Array,
      _1463: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1464: o => o instanceof Int16Array,
      _1465: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1466: o => o instanceof Uint32Array,
      _1467: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1468: o => o instanceof Int32Array,
      _1469: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1471: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1472: o => o instanceof Float32Array,
      _1473: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1474: o => o instanceof Float64Array,
      _1475: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1476: (t, s) => t.set(s),
      _1478: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1480: o => o.buffer,
      _1481: o => o.byteOffset,
      _1482: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1483: (b, o) => new DataView(b, o),
      _1484: (b, o, l) => new DataView(b, o, l),
      _1485: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1486: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1487: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1488: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1489: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1490: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1491: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1492: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1493: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1494: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1495: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1496: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1499: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1500: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1501: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1502: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1503: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1504: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1517: (ms, c) =>
      ...
      _1556: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1556(f,arguments.length,x0,x1) }),
      _1557: o => {
      ...
      _1596: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1597: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      _1613: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1613(f,arguments.length,x0,x1,x2) }),
      _1614: (x0,x1) => x0.forEach(x1),
      _1615: x0 => x0.getReader(),
      _1616: x0 => x0.cancel(),
      _1617: x0 => x0.read(),
      _1618: x0 => x0.trustedTypes,
      _1619: (x0,x1) => { x0.src = x1 },
      _1620: (x0,x1) => x0.createScriptURL(x1),
      _1621: x0 => x0.nonce,
      _1622: (x0,x1) => x0.debug(x1),
      _1623: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1623(f,arguments.length,x0) }),
      _1624: x0 => ({createScriptURL: x0}),
      _1625: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1626: (x0,x1) => x0.appendChild(x1),
      _1627: (x0,x1) => x0.querySelectorAll(x1),
      _1628: x0 => x0.random(),
      _1631: () => globalThis.Math,
      _1641: Function.prototype.call.bind(Number.prototype.toString),
      _1642: Function.prototype.call.bind(BigInt.prototype.toString),
      _1643: Function.prototype.call.bind(Number.prototype.toString),
      _1644: (d, digits) => d.toFixed(digits),
      _1767: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _1768: f => finalizeWrapper(f, function() { return dartInstance.exports._1768(f,arguments.length) }),
      _2094: (x0,x1) => { x0.nonce = x1 },
      _3132: (x0,x1) => { x0.src = x1 },
      _3138: (x0,x1) => { x0.async = x1 },
      _3140: (x0,x1) => { x0.defer = x1 },
      _3601: () => globalThis.window,
      _3642: x0 => x0.document,
      _3919: x0 => x0.isSecureContext,
      _3922: x0 => x0.crypto,
      _3926: x0 => x0.trustedTypes,
      _3927: x0 => x0.sessionStorage,
      _3928: x0 => x0.localStorage,
      _6203: x0 => x0.signal,
      _6212: x0 => x0.length,
