...
--
-- Class AppConfigEntry as table app_config_entry
--
...
--
-- Class AuthAuditLog as table auth_audit_log
--
...
--
-- Class TranslationEntry as table translation_entry
--
...
--
-- Class TwoFactorSecret as table two_factor_secret
--
...
-- Indexes
CREATE UNIQUE INDEX "user_profile_extended_user_id_idx" ON "user_profile_extended" USING btree ("userId");
...
-- Indexes
CREATE INDEX "verification_codes_user_purpose_idx" ON "verification_codes" USING btree ("userId", "purpose");
CREATE INDEX "verification_codes_expires_idx" ON "verification_codes" USING btree ("expiresAt");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('masterfabric_serverpod', '20260201010749325', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260201010749325', "timestamp" = now();
