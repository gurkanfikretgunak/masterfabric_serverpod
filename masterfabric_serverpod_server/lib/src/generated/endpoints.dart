...
import '../services/greetings/endpoints/greeting_endpoint_v3.dart' as _i19;
import '../services/health/endpoints/health_endpoint.dart' as _i20;
import '../services/status/endpoints/status_endpoint.dart' as _i21;
import '../services/translations/endpoints/translation_endpoint.dart' as _i22;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'greetingV3': _i19.GreetingV3Endpoint()
        ..initialize(
          server,
          'greetingV3',
          null,
        ),
      'health': _i20.HealthEndpoint()
        ..initialize(
          server,
          'health',
          null,
        ),
      'status': _i21.StatusEndpoint()
        ..initialize(
          server,
          'status',
          null,
        ),
      'translation': _i22.TranslationEndpoint()
        ..initialize(
          server,
          'translation',
          null,
        ...
        'send': _i1.MethodConnector(
          ...
          params: {
            'request': _i1.ParameterDescription(
              name: 'request',
              type: _i1.getType<_i23.SendNotificationRequest>(),
              nullable: false,
            ),
          },
          call:
        ...
        'createChannel': _i1.MethodConnector(
          ...
          params: {
            ...
            'type': _i1.ParameterDescription(
              name: 'type',
              type: _i1.getType<_i24.ChannelType>(),
              nullable: false,
            ),
      ...
      methodConnectors: {
        ...
        'updateProfileWithVerification': _i1.MethodConnector(
          ...
          params: {
            'request': _i1.ParameterDescription(
              name: 'request',
              type: _i1.getType<_i25.ProfileUpdateRequest>(),
              nullable: false,
            ),
          },
          call:
        ...
        'updatePreferences': _i1.MethodConnector(
          ...
          params: {
            'preferredChannel': _i1.ParameterDescription(
              ...
              type: _i1.getType<_i27.VerificationChannel>(),
              nullable: false,
            ),
    ...
    connectors['greetingV3'] = _i1.EndpointConnector(
      name: 'greetingV3',
      endpoint: endpoints['greetingV3']!,
      methodConnectors: {
        'hello': _i1.MethodConnector(
          name: 'hello',
          params: {
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['greetingV3'] as _i19.GreetingV3Endpoint).hello(
                    session,
                    params['name'],
                  ),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['greetingV3'] as _i19.GreetingV3Endpoint).goodbye(
                    session,
                    params['name'],
                  ),
        ),
        'adminHello': _i1.MethodConnector(
          name: 'adminHello',
          params: {
            'name': _i1.ParameterDescription(
              name: 'name',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['greetingV3'] as _i19.GreetingV3Endpoint)
                  .adminHello(
                    session,
                    params['name'],
                  ),
        ),
        'deleteGreeting': _i1.MethodConnector(
          name: 'deleteGreeting',
          params: {
            'greetingId': _i1.ParameterDescription(
              name: 'greetingId',
              type: _i1.getType<String>(),
              nullable: false,
            ),
        ...
        'moderatorHello': _i1.MethodConnector(
          name: 'moderatorHello',
          params: {
            'name': _i1.ParameterDescription(
              name: 'name',
        ...
        'publicHello': _i1.MethodConnector(
          name: 'publicHello',
          params: {
            'name': _i1.ParameterDescription(
              name: 'name',
        ...
        'strictHello': _i1.MethodConnector(
          name: 'strictHello',
          params: {
            'name': _i1.ParameterDescription(
              name: 'name',
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['health'] as _i20.HealthEndpoint).check(session),
        ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['health'] as _i20.HealthEndpoint).ping(session),
        ),
      },
    );
        ...
        'getStatus': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['status'] as _i21.StatusEndpoint).getStatus(
                session,
              ),
        ),
      },
        ...
        'getTranslations': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['translation'] as _i22.TranslationEndpoint)
                  .getTranslations(
                    session,
