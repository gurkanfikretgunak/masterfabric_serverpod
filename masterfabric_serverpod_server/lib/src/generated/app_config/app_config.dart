...
abstract class AppConfig
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'AppConfig',
      'appSettings': appSettings.toJsonForProtocol(),
      'uiConfiguration': uiConfiguration.toJsonForProtocol(),
      'splashConfiguration': splashConfiguration.toJsonForProtocol(),
      'featureFlags': featureFlags.toJsonForProtocol(),
      'navigationConfiguration': navigationConfiguration.toJsonForProtocol(),
      'apiConfiguration': apiConfiguration.toJsonForProtocol(),
      'permissionsConfiguration': permissionsConfiguration.toJsonForProtocol(),
      'localizationConfiguration': localizationConfiguration
          .toJsonForProtocol(),
      'storageConfiguration': storageConfiguration.toJsonForProtocol(),
      'pushNotificationConfiguration': pushNotificationConfiguration
          .toJsonForProtocol(),
      'forceUpdateConfiguration': forceUpdateConfiguration.toJsonForProtocol(),
    };
  }
